	...
	<div>
		...
		<el-card class="box-card">
			...
			<el-row :gutter="20">
				...
				<el-col :span="3">
					<el-button type="primary" @click="addDialogVisible=true">主要按钮</el-button>
				</el-col>
			</el-row>
			<!-- 用户列表区域 -->
			<el-table border stripe :data="userlist" style="width: 100%">
				...
				<el-table-column label="操作" width="180px">
					<template slot-scope="scope">
						...
						<el-button type="danger" icon="el-icon-delete" size="mini" @click="removeUerById(scope.row.id)"></el-button>
